Each dedicated device using scopeosc should have it's own unique UID. As such we agree ranges of UIDs per developer to avoid conflicts. These are the agreed ranges:
